...
<body id="background" style="Background:url(assets/img/bg.jpg);">
  <!-- navbar -->
      ...
      <div class="collapse navbar-collapse" id="navcol-1" style="margin-right: -93px;">
        <ul class="nav navbar-nav navbar-right">
          ...
          <?php if(!isset($_SESSION['status'])){ ?>
                    ...
                    <?php } else { ?>
                        <li class="nav-item">
                            <a href="information.php" style="color : #000">INFORMATION</a>
                        </li>
                    <?php } ?>
          <?php if(!isset($_SESSION['status'])){ ?>
                        <li class="nav-item">
  ...
  <!-- jumbotron -->
  <div>
    <div class="jumbotron" style="margin-left:54px !important;">
